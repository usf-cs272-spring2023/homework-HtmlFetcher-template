...
public class HtmlFetcher {
	...
	public static boolean isHtml(Map<String, List<String>> headers) {
		// TODO Fill in isHtml implementation
	...
	public static int getStatusCode(Map<String, List<String>> headers) {
		// TODO Fill in getStatusCode implementation
		throw new UnsupportedOperationException("Not yet implemented.");
	}
	...
	public static String getRedirect(Map<String, List<String>> headers) {
		// TODO Fill in getRedirect implementation
		throw new UnsupportedOperationException("Not yet implemented.");
	}
	...
	public static String fetch(URL url, int redirects) {
		...
		try (
			...
			// TODO Fill in fetch implementation
			throw new UnsupportedOperationException("Not yet implemented.");
		}
		catch (IOException e) {
			html = null;
	...
	public static void main(String[] args) throws IOException {
		String link = "https://usf-cs272-spring2023.github.io/project-web/input/birds/falcon.html";
